...
String formatting involves taking a set of variables and, using an expression, formatting them into a provided string that contains placeholders for those variables. This can be achieved using the "%" operator combined with "argument specifiers." Common argument specifiers include:
...
- If the expression evaluates to False, the next block (after the if statement) is execute
